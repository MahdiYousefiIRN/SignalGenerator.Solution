    ...
    public partial class FirstCreateMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SignalGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SignalGroups_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignalGroupsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SignalGroupMembers", x => new { x.MembersId, x.SignalGroupsId });
                    table.ForeignKey(
                        name: "FK_SignalGroupMembers_AspNetUsers_MembersId",
                        column: x => x.MembersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SignalGroupMembers_SignalGroups_SignalGroupsId",
                        column: x => x.SignalGroupsId,
                        principalTable: "SignalGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SignalGroupMembers_SignalGroupsId",
                table: "SignalGroupMembers",
                column: "SignalGroupsId");

            migrationBuilder.CreateIndex(
                name: "IX_SignalGroups_CreatedById",
                table: "SignalGroups",
                column: "CreatedById");
        }
